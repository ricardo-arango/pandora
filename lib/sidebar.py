    ...
    [
        dbc.Nav(
            [
                ...
                dbc.NavLink(children=[html.I(className="fas fa-chart-line fa-2x"), html.H6("Gráficas")], href="/user/ricardoutd@gmail.com/proxy/8050/graficas", active="exact", className="sidebar-icons"),
