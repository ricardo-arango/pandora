...
problem_label = "Actualmente hay un número significativo de crímenes, incluyendo feminicidios y violencia de género en Bucaramanga. Las autoridades locales no cuenta con herramientas de análisis de datos que puedan identificar y predecir zonas espaciales y factores que hacen que ciertos grupos poblacionales sean vulnerables a estos crímenes. Debido a esto, diseñar y implementar planes de mitigación sigue ciendo una tarea compleja y desafiante."
importance_label = "Es crucial reducir las tazas de crimen para salvaguardar las vidas de los habitantes en las zonas rurales y urbanas de la cuidad, independientemente de la raza, género, orientación sexual o creencias religiosas al igual que mejorar la calidad de vida de las personas y la seguridad en Bucaramanga."
