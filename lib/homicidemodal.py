...
def generate_graphic(year, week_day, barrio, grupo_etario, show_by_week_day):
    cases_df = dataloading.crime_df[dataloading.crime_df["TIPO_DELITO"] == "HOMICIDIO"]
    if not year:
        year = 2010
    ...
    if len(show_by_week_day) == 1:
        ...
        fig = px.bar(
            ...
            labels={"TIPO_CONDUCTA": applicationconstants.behaviour_type_label, "TIPO_DELITO": "Tipo Delito"},
            height=800
        )
    else:
